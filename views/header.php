    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header visible-xs">
                ...
                <a class="navbar-brand" href="#"><h2>MeatEater</h2></a>
            </div><!-- navbar-header -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav " >
                <li><a href="index.php#story">О нас</a></li>
                <li <?php if(isset($_GET['page'])&&$_GET['page']=='contact') { echo "class='active'"; } ?>
                ><a href="index.php?page=contact">Контакты</a></li>
                <li><a href="index.php#chefs">Повара</a></li>
                <li <?php if(isset($_GET['page'])&&$_GET['page']=='reservation') { echo "class='active'"; } ?>><a href="index.php?page=reservation">Бронирование</a></li>
                ...
                Корзина :</strong> &nbsp;<?= $_SESSION['sum'] ?> р.</a></li>
